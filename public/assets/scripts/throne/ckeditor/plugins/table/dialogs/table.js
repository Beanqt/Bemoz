  ...
  return {
   ...
   onOk: function() {
    ...
    if (b.info) {
     ...
     bootstrapClass += this.getValueOf('info', 'stripedRows') ? ' table-striped' : '';
     bootstrapClass += this.getValueOf('info', 'bordered') ? ' table-bordered' : '';
     bootstrapClass += this.getValueOf('info', 'hover') ? ' table-hover' : '';
     bootstrapClass += this.getValueOf('info', 'condensed') ? ' table-condensed' : '';
       ...
       children: [
        {
         ...
         required: !0,
         labelStyle: 'margin-top: -10px;display: block;',
