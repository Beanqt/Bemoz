<li class="box" data-type="select">
    <div class="title-box">
        <div class="icon"><i class="fas fa-list-ul"></i></div>
        <div class="title" data-orig-title="@lang('admin.forms.form.menu.select')">{{isset($item['title']) && !empty($item['title']) ? $item['title'] : trans('admin.forms.form.menu.select')}}</div>
    </div>
    <ul class="actions">
