<li class="box" data-type="text">
    <div class="title-box">
        <div class="icon"><i class="fas fa-text-width"></i></div>
        <div class="title" data-orig-title="@lang('admin.forms.form.menu.text')">{{isset($item['title']) && !empty($item['title']) ? $item['title'] : trans('admin.forms.form.menu.text')}}</div>
    </div>
    <ul class="actions">
